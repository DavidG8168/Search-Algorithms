...
//    cout<<"Total nodes: "<<path.size()-1<<endl;
    totalweghit=weight;
...
//int Astar::CalcWeight(list<Point *> path) {
//    int weight=0;
//    for (int i = 0; i <path.size() ; ++i) {
//        weight+= IndexMaze[path[i]->x,path[i]->y]
//
//    }
//}
